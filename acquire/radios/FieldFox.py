...
class FieldFox(QAMRadio):
    ...
    def __init__(self, freq, bw, host, port=5025):
        ...
        self.scpi("SENS:FREQ:STAR {}".format(freq)) # operating frequency
        self.scpi("SENS:FREQ:STOP {}".format(freq))
        self.scpi(":BWID {}".format(bw))          # minimum IF bandwidth
